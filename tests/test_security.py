...
class SessionTests(unittest.TestCase):
    ...
    def test_staff_write_scope_is_limited_to_lead_quality_routes(self):
        ...
        delete_newer_duplicates = SimpleNamespace(method="POST", url=SimpleNamespace(path="/api/leads/delete-newer-duplicates"))
        ...
        self.assertFalse(auth._role_may_write_request("staff", delete_newer_duplicates))
